...
import com.macbarbos.macfood.util.DatabaseCleaner;
import com.macbarbos.macfood.util.ResourceUtils;
...
public class CadastroRestauranteIT {
    ...
    private void prepararDados() {
        ...
        cozinhasRepository.save(cozinhaBrasileira);

        Cozinha cozinhaAmericana = new Cozinha();
        cozinhaAmericana.setNome("Americana");
        cozinhasRepository.save(cozinhaAmericana);

...
public class MacFoodMediaTypes {

	public static final String V1_APPLICATION_JSON_VALUE = "application/vnd.macfood.v1+json";

	public static final MediaType V1_APPLICATION_JSON = MediaType.valueOf(V1_APPLICATION_JSON_VALUE);
	
	public static final String V2_APPLICATION_JSON_VALUE = "application/vnd.macfood.v2+json";
